...
.k.kb-l-top::after{content:'';position:absolute;top:100%;left:-1px;right:-1px;height:4px;background:var(--bg);border-left:1px solid var(--border);border-right:1px solid var(--border);pointer-events:none}
